...
# Electricity
# print('Downloading Electricity NYISO...')
...
# print('Electricity NYISO downloaded')

# ETTm1
print("Downloading ETTm1 NYISO...")
m.download_url(
    "https://mega.nz/file/8LlFRKKA#1B15mP2Nu8bg2UXBvDvlb2wQtrhgqmr7NBgtgh9GynQ",
    "datasets/",
)
m.download_url(
    "https://mega.nz/file/lbVHTKpJ#jIHxfQlx-WWW-tSX7juHsyYYyMrfEiQdGD17jvVINYk",
    "datasets/",
)
print("ETTm1 NYISO downloaded")

# Mujoco
# print('Downloading Mujoco NYISO...')
...
# print('Mujoco NYISO downloading')

# PTB-XL
# print('Downloading PTB-XL NYISO 248...')
...
# print('Downloading PTB-XL NYISO 1000....')
